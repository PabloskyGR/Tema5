...
public class Main {
	...
	public static void main(String[] args) {
		...
		Libro libro1 = new Libro("El señor de los anillos", "J.R.R. Tolkien", 5, 0);
		Libro libro2 = new Libro("Don Quijote de la Mancha", "Miguel de Cervantes", 7, 2);
		Libro libro3 = new Libro("Harry Potter y la piedra filosofal", "J.K. Rowling", 10, 3);
